...
export type Fiber = {|
  ...
  // 表示element.type属性所对应的值，element即ReactElement实例
  elementType: any,

  // The resolved function/class/ associated with this fiber.
  // 在开发环境中这里的type属性和上面的elementType属性相比在外层多了一些解析过程，但是仅对开发环境生效，这里就没有做过多探究了
  // 在生产环境中type和elementType两者几乎保持一致
  type: any,
  ...
  // 表示element.ref属性所对应的值，element即ReactElement实例
...
/**
 * FiberNode构造函数(属性的相关注释信息已经写在上面的Fiber中)
